 ...
 */
require($_SERVER['DOCUMENT_ROOT'] . '/_config.php'); //Aqui, faz a conexão da página config com esta página.
...
if ($_SERVER["REQUEST_METHOD"] == "POST") :
    ...
    $name = post_clean('name', 'string'); //"string" vem da página "_config.php".
